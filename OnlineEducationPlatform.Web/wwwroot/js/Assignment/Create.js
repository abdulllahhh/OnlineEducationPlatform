...
// JS validation for file required on create
document.querySelector('form').addEventListener('submit', function (e) {
    ...
    if (fileInput && !fileInput.value) {
        e.preventDefault();
        if (fileError) fileError.textContent = 'Please upload a PDF file.';
        fileInput.classList.add('is-invalid');
    } else if (fileInput && fileInput.value && !fileInput.value.toLowerCase().endsWith('.pdf')) {
        e.preventDefault();
